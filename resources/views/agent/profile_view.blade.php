        ...
        <div class="card rounded">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-2">
              <div>
                <img class="wd-100 rounded-circle" src="{{(!empty($user->photo)) ? url('uploade/agent_images/'.$user->photo) : url('uploade/no_image.jpg')}}" alt="profile">
            ...
            <div class="card">
                <div class="card-body">
                              ...
                              <div class="mb-3">
                                ...
                                <img src="{{(!empty($user->photo)) ? url('uploade/agent_images/'.$user->photo) : url('uploade/no_image.jpg')}}"
