              ...
              <div class="col-lg-3 border-end-lg">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="order-first">
                    <h4>Mail Service</h4>
                    <p class="text-muted">real-support@gmail.com</p>
                  </div>
                </div>
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item active">
                      <a class="nav-link d-flex align-items-center" href="../email/inbox.html">
                        ...
                        Inbox
                        <span class="badge bg-danger fw-bolder ms-auto">{{count($adminMessages)}}
                      </a>
                    </li>
              ...
              <div class="col-lg-9">
                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <div class="d-flex align-items-end mb-2 mb-md-0">
                        ...
                        <span class="text-muted">({{count($adminMessages)}} new messages)</span>
                      </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="email-list">
                  ...
                  <div class="email-list-item email-list-item--unread">
                    ...
                    <a href="{{route('admin.message.details',$message->id)}}" class="email-list-detail">
                      <div class="content">
