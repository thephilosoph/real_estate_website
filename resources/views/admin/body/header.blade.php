...
<nav class="navbar">
  ...
  <div class="input-group-text">
        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{(!empty($user->photo)) ? url('uploade/admin_images/'.$user->photo) : url('uploade/no_image.jpg')}}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{(!empty($user->photo)) ? url('uploade/admin_images/'.$user->photo) : url('uploade/no_image.jpg')}}" alt="">
                        </div>
    ...
    <ul class="list-unstyled p-1">
      ...
      <li class="dropdown-item py-2">
        <a href="{{route('admin.password.edit')}}" class="text-body ms-0">
