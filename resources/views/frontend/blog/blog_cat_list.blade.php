    ...
    <section class="page-title-two bg-color-1 centred">
        ...
        <div class="auto-container">
            <div class="content-box clearfix">
                <h1>{{$ycategory->category_name}}</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="{{url('/')}}">Home</a></li>
                    <li>{{$ycategory->category_name}}</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><a href="blog-details.html"><img src="{{$post->post_image}}" alt=""></a></figure>
                                        <span class="category">Featured</span>
                                    </div>
                                    <div class="lower-content">
                                        <h4><a href="blog-details.html">{{$post->post_title}}</a></h4>
                                        <ul class="post-info clearfix">
                                            <li class="author-box">
                                                <figure class="author-thumb"><img src="{{(!empty($post->user->photo)) ? url('uploade/admin_images/'.$blog->user->photo) : url('uploade/no_image.jpg')}}" alt=""></figure>
