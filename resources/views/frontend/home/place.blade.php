...
$property_0 = App\Models\Property::where('state',$skip_state_0->id)->count();

$skip_state_1 = App\Models\State::skip(1)->first();
$property_1 = App\Models\Property::where('state',$skip_state_1->id)->count();

$skip_state_2 = App\Models\State::skip(2)->first();
$property_2 = App\Models\Property::where('state',$skip_state_2->id)->count();

$skip_state_3 = App\Models\State::skip(3)->first();
$property_3 = App\Models\Property::where('state',$skip_state_3->id)->count();
@endphp
            ...
            <div class="items-container row clearfix">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration brand marketing software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{asset($skip_state_0->state_image)}}" alt="state image" style="width:370px;height:580px;"></figure>
                            <div class="text">
                                <h4><a href="{{route('state.details',$skip_state_0->id)}}">{{$skip_state_0->state_name}}</a></h4>
                                <p>{{$property_0}} Properties</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all brand illustration print software logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{asset($skip_state_1->state_image)}}" alt="state image" style="width:370px;height:275px;"></figure>
                            <div class="text">
                                <h4><a href="{{route('state.details',$skip_state_1->id)}}">{{$skip_state_1->state_name}}</a></h4>
                                <p>{{$property_1}} Properties</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{asset($skip_state_2->state_image)}}" alt="state image" style="width:370px;height:275px;"></figure>
                            <div class="text">
                                <h4><a href="{{route('state.details',$skip_state_2->id)}}">{{$skip_state_2->state_name}}</a></h4>
                                <p>{{$property_2}} Properties</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{asset($skip_state_3->state_image)}}" alt="state image" style="width:770px;height:275px;"></figure>
                            <div class="text">
                                <h4><a href="{{route('state.details',$skip_state_3->id)}}">{{$skip_state_3->state_name}}</a></h4>
                                <p>{{$property_3}} Properties</p>
                            </div>
                        </div>
                    </div>
                </div>
